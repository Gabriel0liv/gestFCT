                            ...
                            <div class="formbg-inner padding-horizontal--48">
                                ...
                                <div id="stripe-login">
                                    ...
                                    <div class="field padding-bottom--24">
                                        ...
                                        <input id="txt_email" type="email" name="email" required="required" placeholder="Insira seu email de utilizador" runat="server" />
                                    </div>
                                    <div class="field padding-bottom--24">
                                        ...
                                        <input id="txt_pass" type="password" name="password" required="required" placeholder="Insira sua senha" runat="server" />
                                    </div>
