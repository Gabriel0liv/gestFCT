<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestProf.aspx.cs" Inherits="GestaoFCT.GestProf" %>
...
<body class="navbar-fixed sidebar-fixed " id="body">
    ...
    ===================================== -->
        <div class="wrapper">
            ...
            <asp:SqlDataSource ID="ProfSQLData" runat="server" ConnectionString="<%$ ConnectionStrings:FCTConnectionString %>"></asp:SqlDataSource>
                ...
                <div id="sidebar" class="sidebar sidebar-with-footer">
                    ...
                    <div class="sidebar-left" data-simplebar="" style="height: 100%;">
                        ...
                        <ul class="nav sidebar-inner" id="sidebar-menu">
                            ...
                            <li id="NavProf" runat="server" class="active">
            ...
            <div class="page-wrapper">
                ...
                <header class="main-header" id="header">
                    <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
                        ...
                        <span class="page-title">Gestão de Professores</span>
        ...
        <script>
            ...
            var table = new Tabulator("#example-table", {
                ...
                columns: [
                    ...
                    { title: "Telemóvel", field: "telemovel", width: 156, resizable: false, headerFilter: "number" },
                    { title: "Password", field: "passprof", width: 125, resizable: false, headerFilter: "input" },
            ...
            var cat_tabledata = [
                <asp:Repeater ID="rptItems" runat="server">
                    <ItemTemplate>
                        {codigo: '<%#DataBinder.Eval(Container.DataItem, "id_prof") %>',
                    nome: '<%#DataBinder.Eval(Container.DataItem, "nome_prof") %>',
                    nif: '<%#DataBinder.Eval(Container.DataItem, "nif_prof") %>', 
                    email: '<%#DataBinder.Eval(Container.DataItem, "email_prof") %>', 
                    morada: '<%#DataBinder.Eval(Container.DataItem, "morada_prof") %>',
                    localidade: '<%#DataBinder.Eval(Container.DataItem, "loc_prof") %>', 
                    codPost: '<%#DataBinder.Eval(Container.DataItem, "cpostal_prof") %>',
                    telefone: '<%#DataBinder.Eval(Container.DataItem, "telefone_prof") %>',
                    telemovel: '<%#DataBinder.Eval(Container.DataItem, "telemovel_prof") %>',
                    passprof: '<%#DataBinder.Eval(Container.DataItem, "pass_prof") %>'},
